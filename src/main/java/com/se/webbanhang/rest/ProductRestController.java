...
//    private OrderdetaiService orderdetaiService;
    ...
    @GetMapping("/products/product-new")
    public List<Products> listproductnews() {
        List<Products> listproduct = productService.listproductnews();
        return listproduct; 
    }
    @GetMapping("/products/product-new/categories/{categorieId}")
    public List<Products> listproductnewsByCategorieId(@PathVariable int categorieId) {
    ...
    @GetMapping("/products/product-new/store/{storeId}")
    public List<Products> listproductnewsByStoreId(@PathVariable int storeId) {
        List<Products> listproduct = productService.listproductnewsByStoreId(storeId);
        return listproduct; 
    }
